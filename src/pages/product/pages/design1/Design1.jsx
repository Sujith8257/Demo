...
export default function Design1() {
 const ui=useProduct();
 return (<main className="w-full pt-24 sm:pt-28 bg-surface min-h-screen" id="main-content"><div className="flex flex-col w-full"><Section01Section /><Section02AsterNo04Automatic /><Section03TheTechnicalCalibre /><Section04SculptedForTheCollector /><Section05FromTheAsterCollection /><Section06CollectorReviews /><Section07Section /></div></main>);
}
