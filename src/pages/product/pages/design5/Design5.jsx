...
export default function Design5() {
 const ui=useProduct();
 return (<main className="w-full pt-24 sm:pt-28 bg-surface min-h-screen" id="main-content"><div className="flex flex-col w-full"><Section01AsterNo04Automatic /><Section02InsideTheMovementNocturne /><Section03TheMidnightEdit /><Section04CollectorTestimonials /><Section05RecentlyViewedVaultSuggestions /></div></main>);
}
