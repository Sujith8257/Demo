 ...
 return <MotionConfig reducedMotion="user">
  ...
  <AnimatePresence mode="wait" initial={false}>
   <motion.div key={active} initial={reduced?false:{opacity:0,y:12}} animate={{opacity:1,y:0}} exit={reduced?undefined:{opacity:0,y:-9}}
    ...
    <CatalogueProvider key={active} variant={active} cart={cart} setCart={setCart} wishlist={wishlist} setWishlist={setWishlist}>
     <Header/>
     <div id="main-content" className="preview-root"><Page/></div>
     <Footer/>
     <QuickViewModal/>
     <Toast/>
    </CatalogueProvider>
  ...
  <DesignTaskbar active={active} onChange={change}/>
 </MotionConfig>;
}
